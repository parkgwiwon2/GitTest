...
public class pointManagerObject {
	...
	pointManagerObject(String name, int charGeTime, int maxPoint){
		this.name = name;
		this.chargeTime = charGeTime;
		this.maxPoint = maxPoint;
	}

	pointManagerObject(String name, int charGeTime, String formulra, int level){
		this.name = name;
		this.chargeTime = charGeTime;
	...
	public void calculateCargeTime(){
		...
		this.goalTime = (Calendar) this.setTime.clone();
	...
	public void calculateMaxPoint(){
		 ...
		 this.formulra=this.formulra.replace("L", Integer.toString(this.level));
	...
	public void calculrateNowPoint(){
		...
		int chargePoint = (int)(Math.abs(timeDiff)/1000/60/5);
